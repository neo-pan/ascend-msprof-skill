...
|---|---|---|---|---:|---:|---:|---:|---|
| op_summary | not_comparable | n/a | n/a | 83401.66 | 71233.88 | n/a | n/a | reports/app/PROF_000001_20260605155111872_JDEKRCNERPBNJEGA/mindstudio_profiler_output/op_summary_20260605155140.csv; reports/app/PROF_000001_20260605210244379_CQNMQRGLNQDIINJB/mindstudio_profiler_output/op_summary_20260605210312.csv; field missing; metric_scope missing; target unverified; target ambiguous |
| op_statistic | not_comparable | n/a | n/a | 249604.48 | 213086.38 | n/a | n/a | reports/app/PROF_000001_20260605155111872_JDEKRCNERPBNJEGA/mindstudio_profiler_output/op_statistic_20260605155140.csv; reports/app/PROF_000001_20260605210244379_CQNMQRGLNQDIINJB/mindstudio_profiler_output/op_statistic_20260605210312.csv; field missing; metric_scope missing; target unverified; target ambiguous |
| task_time | not_comparable | n/a | n/a | 83404.54 | 71236.66 | n/a | n/a | reports/app/PROF_000001_20260605155111872_JDEKRCNERPBNJEGA/mindstudio_profiler_output/task_time_20260605155140.csv; reports/app/PROF_000001_20260605210244379_CQNMQRGLNQDIINJB/mindstudio_profiler_output/task_time_20260605210312.csv; field missing; metric_scope missing; target unverified; target ambiguous |
| api_statistic | not_comparable | n/a | n/a | 249503.48 | 212963.83 | n/a | n/a | reports/app/PROF_000001_20260605155111872_JDEKRCNERPBNJEGA/mindstudio_profiler_output/api_statistic_20260605155140.csv; reports/app/PROF_000001_20260605210244379_CQNMQRGLNQDIINJB/mindstudio_profiler_output/api_statistic_20260605210312.csv; field missing; metric_scope missing; target unverified; target ambiguous |
| op_basic_info | not_comparable | Task Duration(us) | Task Duration(us) | 83096.421875 | 70925.796875 | n/a | n/a | reports/followups/collect_default_metric_followup/OPPROF_20260605170714_RYQFPTCBYWBFCNBI/OpBasicInfo.csv (Task Duration(us)); reports/followups/collect_default_metric_followup/OPPROF_20260605210408_RQSTPBCUOTTFXTMZ/OpBasicInfo.csv (Task Duration(us)); profiler.segment.followup:collect_default_metric_followup.output mismatch; profiler.segment.followup:collect_default_metric_followup.command missing; target unverified; target ambiguous |
| pipe_utilization | not_comparable | aiv_scalar_ratio | aiv_scalar_ratio | 0.16759 | 0.167571 | n/a | n/a | reports/followups/collect_default_metric_followup/OPPROF_20260605170714_RYQFPTCBYWBFCNBI/PipeUtilization.csv (aiv_scalar_ratio); reports/followups/collect_default_metric_followup/OPPROF_20260605210408_RQSTPBCUOTTFXTMZ/PipeUtilization.csv (aiv_scalar_ratio); profiler.segment.followup:collect_default_metric_followup.output mismatch; profiler.segment.followup:collect_default_metric_followup.command missing; target unverified; target ambiguous |
...
| memory | not_comparable | L1_to_GM_bw_usage_rate(%)(estimate) | GM_to_UB_bw_usage_rate(%) | 6e-06 | 2.4e-05 | n/a | n/a | reports/followups/collect_default_metric_followup/OPPROF_20260605170714_RYQFPTCBYWBFCNBI/Memory.csv (L1_to_GM_bw_usage_rate(%)(estimate)); reports/followups/collect_default_metric_followup/OPPROF_20260605210408_RQSTPBCUOTTFXTMZ/Memory.csv (GM_to_UB_bw_usage_rate(%)); profiler.segment.followup:collect_default_metric_followup.output mismatch; profiler.segment.followup:collect_default_metric_followup.command missing; field mismatch; name mismatch; block_scope mismatch; target unverified; target ambiguous |
...
- Available evidence:
  ...
  - `candidate: memory_cache summary signal: reports/followups/collect_default_metric_followup/OPPROF_20260605210408_RQSTPBCUOTTFXTMZ/Memory.csv (headlines.memory.value; headlines.memory.raw_row.GM_to_UB_bw_usage_rate(%); headlines.memory.field=GM_to_UB_bw_usage_rate(%); headlines.memory.field_kind=memory_usage_rate)`
  ...
  - `candidate: memory_cache summary signal: reports/followups/collect_default_metric_followup/OPPROF_20260605210408_RQSTPBCUOTTFXTMZ/L2Cache.csv (headlines.l2_cache)`
...
- Available evidence:
  ...
  - `candidate: pipe_arithmetic summary signal: reports/followups/collect_default_metric_followup/OPPROF_20260605210408_RQSTPBCUOTTFXTMZ/ArithmeticUtilization.csv (headlines.arithmetic_utilization.value; headlines.arithmetic_utilization.raw_row.aiv_vec_ratio; headlines.arithmetic_utilization.field=aiv_vec_ratio; headlines.arithmetic_utilization.field_kind=utilization_or_ratio)`
  - `candidate: pipe_arithmetic summary signal: reports/followups/collect_default_metric_followup/OPPROF_20260605210408_RQSTPBCUOTTFXTMZ/ArithmeticUtilization.csv (headlines.arithmetic_utilization)`
...
- Available evidence:
  ...
  - `candidate: work distribution summary signal: reports/app/PROF_000001_20260605210244379_CQNMQRGLNQDIINJB/mindstudio_profiler_output/task_time_20260605210312.csv (headlines.task_time.value; headlines.task_time.raw_row.task_time(us); headlines.task_time.field_kind=duration_or_time)`
