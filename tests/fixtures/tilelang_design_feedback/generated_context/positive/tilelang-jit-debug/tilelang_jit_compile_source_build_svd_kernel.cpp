...
extern "C" __global__ __aicore__ void main_kernel( GM_ADDR A_handle,  GM_ADDR U_handle,  GM_ADDR S_handle,  GM_ADDR VH_handle, uint64_t fftsAddr) {
  ...
  auto x_sh = ascend_l1.GetWithOffset<float>(1024, 0);
  auto v_sh = ascend_l1.GetWithOffset<float>(1024, 4096);
  auto sigma_sh = ascend_l1.GetWithOffset<float>(392, 8192);
    ...
    if (vid == 0) {
      for (int32_t i = 0; i < 32; ++i) {
        for (int32_t j = 0; j < 32; ++j) {
          x_sh.SetValue(((((j / 8) * 256) + (i * 8)) + (j % 8)), A.GetValue((((cid * 1024) + (i * 32)) + j)));
          if (i == j) {
        ...
        for (int32_t p = 0; p < 32; ++p) {
          for (int32_t q = (p + 1); q < 32; ++q) {
            ...
            for (int32_t k = 0; k < 32; ++k) {
              x_kp = x_sh.GetValue(((((p / 8) * 256) + (k * 8)) + (p % 8)));
              x_kq = x_sh.GetValue(((((q / 8) * 256) + (k * 8)) + (q % 8)));
              x_kp = x_sh.GetValue(((((p / 8) * 256) + (k * 8)) + (p % 8)));
              x_kq = x_sh.GetValue(((((q / 8) * 256) + (k * 8)) + (q % 8)));
              app = (app + (x_kp * x_kp));
              aqq = (aqq + (x_kq * x_kq));
            ...
            if (rotate != 0) {
              ...
              for (int32_t k_1 = 0; k_1 < 32; ++k_1) {
                x_kp_1 = x_sh.GetValue(((((p / 8) * 256) + (k_1 * 8)) + (p % 8)));
                x_kq_1 = x_sh.GetValue(((((q / 8) * 256) + (k_1 * 8)) + (q % 8)));
                x_kp_1 = x_sh.GetValue(((((p / 8) * 256) + (k_1 * 8)) + (p % 8)));
                x_kq_1 = x_sh.GetValue(((((q / 8) * 256) + (k_1 * 8)) + (q % 8)));
                x_sh.SetValue(((((p / 8) * 256) + (k_1 * 8)) + (p % 8)), ((c * x_kp_1) - (s_rot * x_kq_1)));
                x_sh.SetValue(((((q / 8) * 256) + (k_1 * 8)) + (q % 8)), ((s_rot * x_kp_1) + (c * x_kq_1)));
              }
      ...
      for (int32_t j_2 = 0; j_2 < 32; ++j_2) {
        ...
        for (int32_t i_1 = 0; i_1 < 32; ++i_1) {
          x_ij = x_sh.GetValue(((((j_2 / 8) * 256) + (i_1 * 8)) + (j_2 % 8)));
          x_ij = x_sh.GetValue(((((j_2 / 8) * 256) + (i_1 * 8)) + (j_2 % 8)));
      ...
      for (int32_t i_2 = 0; i_2 < 32; ++i_2) {
        ...
        if (best_idx != i_2) {
          ...
          for (int32_t k_3 = 0; k_3 < 32; ++k_3) {
            tmp_x = x_sh.GetValue(((((i_2 / 8) * 256) + (k_3 * 8)) + (i_2 % 8)));
            tmp_x = x_sh.GetValue(((((i_2 / 8) * 256) + (k_3 * 8)) + (i_2 % 8)));
            x_sh.SetValue(((((i_2 / 8) * 256) + (k_3 * 8)) + (i_2 % 8)), x_sh.GetValue(((((((int64_t)best_idx) / (int64_t)8) * (int64_t)256) + (((int64_t)k_3) * (int64_t)8)) + (((int64_t)best_idx) % (int64_t)8))));
            x_sh.SetValue(((((((int64_t)best_idx) / (int64_t)8) * (int64_t)256) + (((int64_t)k_3) * (int64_t)8)) + (((int64_t)best_idx) % (int64_t)8)), tmp_x);
          }
      ...
      for (int32_t i_3 = 0; i_3 < 32; ++i_3) {
        for (int32_t j_4 = 0; j_4 < 32; ++j_4) {
          if (1.000000e-06f < sigma_sh.GetValue((((j_4 / 8) * 128) + (j_4 % 8)))) {
            U.SetValue((((cid * 1024) + (i_3 * 32)) + j_4), (x_sh.GetValue(((((j_4 / 8) * 256) + (i_3 * 8)) + (j_4 % 8))) / sigma_sh.GetValue((((j_4 / 8) * 128) + (j_4 % 8)))));
          } else {
      ...
      for (int32_t j_6 = 0; j_6 < 32; ++j_6) {
        ...
        for (int32_t i_9 = 0; i_9 < 32; ++i_9) {
          sigma_1 = (sigma_1 + (U.GetValue((((cid * 1024) + (i_9 * 32)) + j_6)) * x_sh.GetValue(((((j_6 / 8) * 256) + (i_9 * 8)) + (j_6 % 8)))));
        }
