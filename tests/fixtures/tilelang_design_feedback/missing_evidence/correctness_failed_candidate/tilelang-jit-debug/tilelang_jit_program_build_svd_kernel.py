...
def main(A: T.Buffer((256, 32, 32), "float32"), U: T.Buffer((256, 32, 32), "float32"), S: T.Buffer((256, 32), "float32"), VH: T.Buffer((256, 32, 32), "float32")):
    ...
    with T.block("tilelang_root"):
        T.reads(A[cid, 0, 0], U[cid, 0:32, 0:32])
        ...
        norm_2 = T.alloc_buffer((1,), data=norm_1, scope="local.var")
        ...
        norm_3 = T.alloc_buffer((1,), data=norm, scope="local.var")
        ...
        if vid == 0:
            ...
            sweeps: T.int32 = 12
            T.ascend_copy(T.region(A[b, 0, 0], 1, 1, 32, 32), T.region(x_sh[0, 0], 2, 32, 32), T.bool(False), T.bool(False), 0)
