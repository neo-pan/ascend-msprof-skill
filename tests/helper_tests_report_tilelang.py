...
class ReportTileLangTests(unittest.TestCase):
    def test_generate_report_empty_run_collects_artifacts(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertNotIn("Inspect No finite application timing observation was parsed", report)
    ...
    def test_generate_report_surfaces_default_vector_fields(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("| Pipe observations | vector0 / aiv_scalar_ratio | 0.992752 |", report)
            ...
            self.assertIn("| Conflict observations | vector0 / aiv_vec_wait_ratio | 0.3824 |", report)
    ...
    def test_generate_report_uses_provenance_without_diagnosis(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("No finite application timing observation was parsed", diagnosis)
